...
const HEXAGONS_INCLUSION_TO_SET_A_STARTED_STATE_TEXT = "Click on the map to include from 1 to 25 hexagons to set A, then click the A button again to save them.";
const HEXAGONS_INCLUSION_TO_SET_A_FINISHED_STATE_TEXT = "Hexagons included to set A!";
const HEXAGONS_INCLUSION_TO_SET_B_STARTED_STATE_TEXT = "Click on the map to include from 1 to 25 hexagons to set B, then click the B button again to save them.";
